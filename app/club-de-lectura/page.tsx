    ...
    <main className="min-h-screen bg-[#F7F3EE] text-[#403A36] pt-12 pb-24 selection:bg-[#D8B7B0] selection:text-white">
      <div className="max-w-6xl mx-auto px-5 md:px-8 space-y-16">
        ...
        <section className="space-y-12">
          ...
          <section className="club-stats-link-card">
            <div className="club-stats-link-icon">📊</div>

            <div>
              <div className="club-stats-link-kicker">
                Balance del Club
              </div>

              <h2 className="club-stats-link-title">
                Estadísticas del Club de Lectura
              </h2>

              <p className="club-stats-link-text">
                Consulta el resumen de las lecturas conjuntas: libros compartidos,
                géneros más repetidos, recomendaciones, duración media y evolución por año.
              </p>

              <Link
                href="/club-de-lectura/estadisticas"
                className="club-stats-link-button"
              >
                Ver estadísticas →
              </Link>
            </div>
            ...
            {nextReading ? (
              ...
              >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label={`Ver ${nextReading.titulo} en Goodreads`}
                  style={{
                    display: "inline-flex",
                    alignItems: "center",
                    justifyContent: "center",
